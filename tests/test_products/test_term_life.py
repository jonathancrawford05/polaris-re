...
class TestTermLifeProjection:
    ...
    def test_single_policy_total_premiums(self, single_policy_block, standard_projection_config):
        """
    ...
    def test_reserves_zero_at_expiry(self, single_policy_block, standard_projection_config):
        """
    ...
    def test_lx_monotonically_decreasing(self, single_policy_block, standard_projection_config):
        """
